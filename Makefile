##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.7.1] date: [Sun Nov 15 16:51:03 PST 2020] 
##########################################################################################################################
...
-DDEBUG \
-DDEBUG_LOG_TX \
-DTERMINAL_8BIT_COLOR \
-DTERMINAL_ALT_CELLS \
-DTERMINAL_SERIAL_WORD_LENGTH
...
#######################################
# link script
LDSCRIPT = STM32F469VGTx_FLASH.ld
...
debug: all
	gdb-multiarch -q -x openocd.gdb $(BUILD_DIR)/$(TARGET).elf
